import React, { JSX, useCallback, memo } from 'react';
...
export const CanvasScreen = (): JSX.Element => {
  ...
  const handleToggleDraw = useCallback(() => setDrawingMode(!isDrawingMode), [setDrawingMode, isDrawingMode]);
        ...
        >
          <View style={styles.toolbarContent}>
            ...
            <TouchableOpacity
              ...
              disabled={!canUndo}
            >
              <View style={[styles.iconPlaceholder, { justifyContent: 'center', alignItems: 'center' }]}>
                <Text style={{ fontSize: 16, color: canUndo ? themeColors.text : themeColors.textSecondary }}>↩️</Text>
              </View>
              <Text style={[styles.toolLabel, { color: canUndo ? themeColors.text : themeColors.textSecondary }]}>Undo</Text>
            </TouchableOpacity>
            ...
            >
               <View style={[styles.iconPlaceholder, { justifyContent: 'center', alignItems: 'center' }]}>
                <Text style={{ fontSize: 16, color: canRedo ? themeColors.text : themeColors.textSecondary }}>↪️</Text>
              </View>
              <Text style={[styles.toolLabel, { color: canRedo ? themeColors.text : themeColors.textSecondary }]}>Redo</Text>
            </TouchableOpacity>
